...
function renderAnalyseScreen() {
  ...
  screen.innerHTML = `
    ...
    <div id="asub-content-scan">
      ...
      <!-- Scan resultaten in Analyse tab -->
      <div id="analyseScanResults" style="margin-top:.75rem;"></div>
  ...
  // Toon scan resultaten als die beschikbaar zijn
  setTimeout(() => {
...
- Geen uitleg buiten JSON`,
    ...
    // Sla scan resultaten op (voor scan results panel) — inclusief alle velden
    ...
    // Geen scan resultaten meer in wedstrijden tab
