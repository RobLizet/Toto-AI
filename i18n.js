...
(function () {
  ...
  var I18N = {
    nl: {
      ...
      'dash.tile.valuepicks': 'VALUE PICKS',
      'dash.tile.valuepicks_sub': 'Alle value picks met reliability, edge en CLV',
      'bet365.open': 'Open bij Bet365',
      'bet365.copied': '📋 Wedstrijd gekopieerd — plak in de Bet365-zoekbalk',
      ...
      'dash.aicalib2': 'AI GEKALIBREERD',
      'dash.comps': 'comp.',
      'dash.nog': 'nog',
      'dash.picks': 'picks',
      'dash.nietgemeten': 'niet gemeten',
      ...
      'wal.importjacks': '📸 Import via screenshot',
    ...
    en: {
      ...
      'wed.grp_clubliga': 'Club competitions',
      ...
      'wed.favbtn': 'FAVOURITES',
      'wed.morebtn': 'MORE',
      'wed.favbar': 'FAVOURITES',
      'wed.favhint': 'Tap competitions to save them as favourites (they stay visible at the top). Pick 2 or more to scan them together.',
      ...
      'dash.tile.valuepicks': 'VALUE PICKS',
      'dash.tile.valuepicks_sub': 'All value picks with reliability, edge and CLV',
      'bet365.open': 'Open in Bet365',
      'bet365.copied': '📋 Match copied — paste into the Bet365 search bar',
      ...
      'dash.aicalib2': 'AI CALIBRATED',
      'dash.comps': 'comp.',
      'dash.nog': 'need',
      'dash.picks': 'more picks',
      'dash.nietgemeten': 'not measured',
