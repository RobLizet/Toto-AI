...
const SW_VERSION = '36.353'; // v26.353: gegroepeerde competitietegels (16 bekers/interlands zichtbaar) + browse-seizoen uit de worker (fix lege lijst per 07/08) // v26.352: oddsvergelijker goals-variant (O/U + BTTS lijnbeweging via /goals-history) // v26.351: oddsvergelijker-scherm zelf-vullend (silent /picks-refresh) // v26.350: oddsvergelijker B — heel vergelijkerscherm met lijnbeweging (dormant achter model_config.oddsvergelijker_enabled); SW_VERSION mee omhoog want sw.js serveert HTML/JS cache-first // v26.349: eerlijke melding bij de Engelse taalknop (interface deels vertaald) // v26.348: 28 ontbrekende Engelse vertalingen aangevuld // v26.347: uitgesloten onspeelbare picks zichtbaar in de clubtijdperk-teller op het dashboard // v26.346: beheerpagina toont 'niet gemeten' i.p.v. nul gebruikers // v26.345: competitielijst komt van de worker (optie C) // v26.344: NIET GESCAND-markering op wedstrijden buiten het scanbereik // v26.343: Eliteserien en Allsvenskan zichtbaar in de app // v26.342: beheerpagina onthoudt de secret tussen sessies + vergrendelknop // v26.341: eigen icoon + manifest voor de beheerpagina // v26.340: beheerpagina admin.html uitgebreid tot controlepaneel + OneSignal-scope gelijkgetrokken met de hoofd-app // v26.339: clubtijdperk-teller op het dashboard (7/100), bron worker v299 // v26.338: AI-calibratie per competitie uit worker + TRACKRECORD-kop telt echte picks // v26.337: splash-animatie ~30% trager, CSS+JS in een pas // v26.336: splash vloeit over in dashboard (.9s fade, CSS-fail-safe meegetrokken) // v26.335: grafiek/filters/popup/CSV ook op backend-picks (pmxBackendScanLog) // v26.334: SCANS-blok -> TRACKRECORD uit backend-picks; dode logScanResult verwijderd // v26.333: OneSignal-worker naar eigen scope /onesignal/ -- sw.js claimde scope / en sloopte bij elke deploy het pushabonnement // v26.325: oddsvergelijker A (vergelijk 13 boeken per pick) // v26.324: WK-scaffolding opgeruimd -> 19 CLUB19-competities terug in KIES COMPETITIE + wit-op-wit tegelnaam gefixt
