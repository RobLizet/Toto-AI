...
function renderMatchCard(m) {
  ...
  // Kans balken
  const probBar = (m.homePct && m.drawPct && m.awayPct) ? `
    <div class="ai-probs">
      <div class="prob-seg prob-home" style="flex:${m.homePct}">
        <span class="prob-label">1 ${m.homePct}%</span>
      </div>
      <div class="prob-seg prob-draw" style="flex:${m.drawPct}">
        <span class="prob-label">X ${m.drawPct}%</span>
      </div>
      <div class="prob-seg prob-away" style="flex:${m.awayPct}">
        <span class="prob-label">2 ${m.awayPct}%</span>
      </div>
    </div>` : '';
