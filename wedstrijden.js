...
const COMP_LIST = [
  ...
  { key:'championship', flag:'🏴', name:'Championship' },
...
async function fetchOddsForMatches(leagueId, _apiKey) {
  if (!leagueId) return;
  try {
    const r = await apiFetch(`https://v3.football.api-sports.io/odds?league=${leagueId}&season=${leagueId===1?2026:2025}&bookmaker=6`, null, 8000);
