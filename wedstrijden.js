  ...
  card.innerHTML = `
    ...
    <div style="display:flex;gap:.4rem;padding:.0rem .9rem .7rem;">
      ...
      <button onclick="event.stopPropagation();openJacks('${m.id}')"
        style="padding:.4rem .55rem;border-radius:9px;background:rgba(255,140,0,.1);
        border:1px solid rgba(255,140,0,.3);font-family:monospace;font-size:.55rem;
        font-weight:700;color:#e67e00;cursor:pointer;"
        title="Open bij Jacks">
        🎰
      </button>
    </div>` : `
