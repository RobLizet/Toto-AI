...
function renderDashboard() {
  ...
  screen.innerHTML = `
    ...
    <div class="dash-nav-grid">
      ...
      <div class="dash-nav-card" onclick="switchScreen('wedstrijden');setTimeout(()=>openCompDetail(state.activeComp),300)">
        <div class="dash-nav-icon">🏆</div>
