...
function renderDashboard() {
  ...
  const laatsteScanCard = (_latestScan && (_latestScan.picks||[]).filter(p=>!matchHasStarted(p)).length) ? (() => {
    ...
    lp.forEach(p => {
      ...
      h += '<div style="font-family:\'IBM Plex Mono\',monospace;font-size:.44rem;color:rgba(255,255,255,.85);">'+(p.pickLabel||p.pick||'')+' · @'+(Number(p.odds)||0).toFixed(2)+'</div></div>';
  ...
  screen.innerHTML = `
    ...
    <div style="display:flex;gap:.4rem;margin-bottom:.75rem;background:rgba(15,23,42,.04);border-radius:12px;padding:.25rem;">
      ...
      <button id="dashTabLive" onclick="switchDashTab('live')" style="flex:1;border:none;border-radius:9px;padding:.5rem;font-family:\'IBM Plex Mono\',monospace;font-size:.5rem;font-weight:700;cursor:pointer;background:transparent;color:rgba(255,255,255,.85);"><span id="liveDot" style="display:inline-block;width:7px;height:7px;border-radius:50%;background:#dc2626;margin-right:.3rem;vertical-align:middle;"></span>LIVE</button>
    </div>
    ...
    <div class="dash-soft" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.09);border-radius:16px;padding:.8rem 1rem;margin-bottom:.75rem;cursor:pointer;backdrop-filter:blur(8px);"
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;">
        <div style="flex:1;padding-right:.5rem;">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:.5rem;">
            <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.52rem;font-weight:800;color:rgba(255,255,255,.85);">🎯 VOORTGANG NAAR <span style="color:#00BEC4;">100</span> PICKS</div>
          ...
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.44rem;color:rgba(255,255,255,.85);display:flex;gap:.35rem;flex-wrap:wrap;">
            ${(() => {
      ...
      ${state._clvSummary && Number(state._clvSummary.picks) >= 20 ? `<div style="display:flex;align-items:center;justify-content:center;gap:.4rem;margin-top:.5rem;padding-top:.5rem;border-top:1px solid rgba(255,255,255,0.07);">
        <span style="font-family:'IBM Plex Mono',monospace;font-size:.46rem;color:rgba(255,255,255,.85);">\u{1F4C8} GEM. CLV</span>
        ...
        <span style="font-family:'IBM Plex Mono',monospace;font-size:.46rem;color:rgba(255,255,255,.75);">\u00b7 ${state._clvSummary.pctBeatClose}% beat close \u00b7 n=${state._clvSummary.picks}</span>
      </div>` : ''}
    </div>
    ...
    <div style="background:rgba(0,190,196,.06);border:1px solid rgba(0,190,196,.2);border-radius:14px;
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;">
        <div>
          ...
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.46rem;color:rgba(255,255,255,.85);margin-top:.15rem;">${openBets.slice(0,2).map(b=>b.matchName||b.match||'?').join(' · ')}</div>
        </div>
    ...
    <div style="background:linear-gradient(135deg,rgba(22,163,74,.08),rgba(5,150,105,.04));
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;">
        <div style="flex:1;">
          ...
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.5rem;color:rgba(255,255,255,.85);margin-top:.15rem;">${topValuePick.pickLabel||topValuePick.pick} · conf ${topValuePick.confidence||'?'}/10</div>
        </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px;">
      ...
      <div onclick="switchScreen('wedstrijden')"
        ...
        <div style="font-family:\'Plus Jakarta Sans\',sans-serif;font-size:10.5px;color:rgba(255,255,255,.85);line-height:1.5;flex:1;">Laad matches, bekijk quotes en value indicators</div>
      ...
      <div onclick="switchScreen('analyse')"
        ...
        <div style="font-family:\'Plus Jakarta Sans\',sans-serif;font-size:10.5px;color:rgba(255,255,255,.85);line-height:1.5;flex:1;">AI analyse, value scan en combi tips</div>
      ...
      <div onclick="switchScreen('wallet');setTimeout(()=>setWalletSubTab('wallet'),100)"
        ...
        <div style="font-family:\'Plus Jakarta Sans\',sans-serif;font-size:10.5px;color:rgba(255,255,255,.85);line-height:1.5;flex:1;">Bets, tracker, backtest en pick analyse</div>
      ...
      <div onclick="typeof openCompKeuze==='function'?openCompKeuze():switchScreen('wedstrijden')"
        ...
        <div style="font-family:\'Plus Jakarta Sans\',sans-serif;font-size:10.5px;color:rgba(255,255,255,.85);line-height:1.5;flex:1;">Stand, topscorers en wedstrijden per competitie</div>
    ...
    <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.09);border-radius:14px;padding:.75rem 1rem;margin-bottom:.75rem;">
      <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.5rem;font-weight:800;color:rgba(255,255,255,.85);margin-bottom:.5rem;">📅 DEZE WEEK</div>
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:.4rem;">
        <div style="text-align:center;background:rgba(15,23,42,.04);border-radius:10px;padding:.4rem;">
          ...
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.38rem;color:rgba(255,255,255,.85);">SCANS</div>
        </div>
        <div style="text-align:center;background:rgba(15,23,42,.04);border-radius:10px;padding:.4rem;">
          <div style="font-family:\'Bebas Neue\',sans-serif;font-size:1rem;color:#00a8ad;">${weekPicksArr.length}</div>
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.38rem;color:rgba(255,255,255,.85);">PICKS</div>
        </div>
        <div style="text-align:center;background:rgba(15,23,42,.04);border-radius:10px;padding:.4rem;">
          ...
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.38rem;color:rgba(255,255,255,.85);">HITRATE</div>
        </div>
        <div style="text-align:center;background:rgba(15,23,42,.04);border-radius:10px;padding:.4rem;">
          <div style="font-family:\'Bebas Neue\',sans-serif;font-size:1rem;color:#00BEC4;">${weekOpen}</div>
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.38rem;color:rgba(255,255,255,.85);">OPEN</div>
        </div>
      </div>
    </div>` : ''}
    ...
    <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.09);border-radius:14px;padding:.75rem 1rem;margin-bottom:.75rem;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.5rem;">
        <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.5rem;font-weight:800;color:rgba(255,255,255,.85);">📊 TRACKRECORD</div>
        <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.46rem;color:rgba(255,255,255,.85);">${settledPicks.length}/100 picks</div>
      </div>
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:.5rem;">
        <div style="text-align:center;background:rgba(15,23,42,.04);border-radius:10px;padding:.4rem;">
          ...
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.4rem;color:rgba(255,255,255,.85);">HITRATE</div>
        </div>
        <div style="text-align:center;background:rgba(15,23,42,.04);border-radius:10px;padding:.4rem;">
          <div style="font-family:\'Bebas Neue\',sans-serif;font-size:1rem;color:${scanROI>=0?'#00BEC4':'#dc2626'};">${scanROI>=0?'+':''}${scanROI.toFixed(1)}%</div>
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.4rem;color:rgba(255,255,255,.85);">ROI</div>
        </div>
        <div style="text-align:center;background:rgba(15,23,42,.04);border-radius:10px;padding:.4rem;">
          ...
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.4rem;color:rgba(255,255,255,.85);">${isCalibrated?'AI GECALIB.':'AI LEERT'}</div>
        </div>
      </div>
    ...
    <!-- Disclaimer -->
    <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.46rem;color:rgba(255,255,255,.85);text-align:center;padding:.75rem;line-height:1.6;border-top:1px solid rgba(255,255,255,0.09);margin-top:.5rem;">
      ⚠️ Uitsluitend voor <b>entertainment & educatie</b> · Geen echt gokadvies<br>
      Speel verantwoord · 18+ · Verslavingslijn: 0900-1090
    </div>

    <div style="font-family:'Dancing Script',cursive;font-size:.75rem;color:rgba(255,255,255,.85);text-align:center;padding:.5rem 0 1rem;">
    ...
    <div id="dashLiveContent" style="display:none;">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:.6rem;">
        <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.52rem;font-weight:800;color:rgba(255,255,255,.85);">🔴 LIVE STANDEN VAN JE PICKS</div>
        <button onclick="loadLiveScores()" style="background:none;border:1px solid rgba(255,255,255,0.09);border-radius:8px;padding:.25rem .5rem;font-family:\'IBM Plex Mono\',monospace;font-size:.42rem;color:rgba(255,255,255,.85);cursor:pointer;">⟳ Ververs</button>
      </div>
      <div id="liveScoresList"><div style="text-align:center;padding:2rem;color:rgba(255,255,255,.85);font-family:\'IBM Plex Mono\',monospace;font-size:.5rem;">Tik op LIVE om standen te laden...</div></div>
    </div>
  `;
...
function renderDailyTipCard(tip) {
    ...
    if (!tip || !tip.qualified) {
      tipCard.innerHTML = `<div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.09);border-radius:16px;padding:.75rem 1rem;opacity:.6;">
        <div style="display:flex;align-items:center;gap:.5rem;">
          ...
          <div>
            <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.56rem;font-weight:800;color:rgba(255,255,255,.85);">TIP VAN DE DAG</div>
            <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.5rem;color:rgba(255,255,255,.85);">Vandaag geen gekwalificeerde pick — scan meer wedstrijden.</div>
          </div>
        </div>
      </div>`;
      return;
    ...
    tipCard.innerHTML = `<div style="background:linear-gradient(135deg,rgba(0,190,196,.08),rgba(0,168,173,.06));
      ...
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.5rem;">
        ...
        <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.42rem;color:rgba(255,255,255,.85);">${isToday ? 'Vandaag' : (tip.date||'')}</div>
      </div>
      ...
      <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.5rem;color:rgba(255,255,255,.85);line-height:1.65;">${tip.analyse||tip.tip||''}</div>
      ...
      <div style="margin-top:.45rem;font-family:\'IBM Plex Mono\',monospace;font-size:.44rem;color:rgba(255,255,255,.85);opacity:.7;">
...
function openCompKeuze() {
  ...
  COMPS.forEach(c => {
    ...
    tile.innerHTML = `<div style="font-size:1.4rem;">${c.flag}</div><div style="font-family:\'IBM Plex Mono\',monospace;font-size:.44rem;font-weight:700;color:rgba(255,255,255,.85);margin-top:.2rem;">${c.name}</div>`;
    tile.onclick = () => {
      overlay.remove();
...
async function openPicksInsight() {
  ...
  sheet.innerHTML = `
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:.9rem;">
      ...
      <button onclick="this.closest('[style*=fixed]').remove()" style="background:none;border:none;color:rgba(255,255,255,.75);font-size:1.2rem;cursor:pointer;">✕</button>
    </div>
    <div id="insightContent">
      <div style="text-align:center;padding:2rem 0;">
        <div style="font-family:'IBM Plex Mono',monospace;font-size:.6rem;color:rgba(255,255,255,.75);">⏳ AI analyseert jouw statistieken...</div>
      </div>
    </div>`;
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:.4rem;margin-bottom:.85rem;">
        ${[
          ...
          <div style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.09);border-radius:10px;padding:.45rem .3rem;text-align:center;">
            ...
            <div style="font-family:'IBM Plex Mono',monospace;font-size:.36rem;color:rgba(255,255,255,.75);margin-top:2px;">${label}</div>
          </div>`).join('')}
      </div>`;
...
function showPicksModal() {
  ...
  sheet.innerHTML = `
    ...
    <details open style="background:rgba(0,190,196,.06);border:1px solid rgba(0,190,196,.18);border-radius:10px;padding:.5rem .7rem;margin-bottom:.75rem;">
      ...
      <div style="font-family:'IBM Plex Mono',monospace;font-size:.54rem;color:rgba(255,255,255,.85);line-height:1.7;margin-top:.5rem;">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:.4rem;margin-bottom:.75rem;">
      ${[
        ...
        <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.09);border-radius:10px;padding:.4rem;text-align:center;">
          <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.38rem;color:rgba(255,255,255,.85);">${label}</div>
    ...
    ${sorted.length === 0 ? '<div style="text-align:center;color:rgba(255,255,255,.85);font-size:.8rem;padding:1rem;">Nog geen picks — scan wedstrijden!</div>' :
      sorted.map(p => {
        ...
        return `<div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.09);border-radius:10px;padding:.5rem .7rem;margin-bottom:.4rem;display:flex;flex-direction:column;">
          <div style="display:flex;justify-content:space-between;align-items:flex-start;">
            <div style="flex:1;min-width:0;">
              ...
              <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.6rem;color:rgba(255,255,255,.85);">${p.pickLabel||p.pick||'?'} · @${parseFloat(p.odds||2).toFixed(2)} · +${Math.round(p.value||0)}% value</div>
            </div>
          ...
          <div style="display:flex;align-items:center;gap:.4rem;margin:.3rem 0;">
            <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.46rem;color:rgba(255,255,255,.75);">RELIABILITY</div>
...
async function loadLiveScores() {
  ...
  if (!uniquePicks.length) {
    list.innerHTML = '<div style="text-align:center;padding:2rem;color:rgba(255,255,255,.85);font-family:\'IBM Plex Mono\',monospace;font-size:.5rem;line-height:1.6;">Geen openstaande picks om live te volgen.<br>Doe eerst een scan!</div>';
    return;
  }
  ...
  try {
    ...
    // Update tijd
    const now = new Date();
    list.innerHTML += `<div style="text-align:center;padding:.5rem;color:rgba(255,255,255,.85);font-family:\'IBM Plex Mono\',monospace;font-size:.4rem;">Laatst bijgewerkt: ${now.toLocaleTimeString('nl-NL',{hour:'2-digit',minute:'2-digit',second:'2-digit'})} · ververst elke 60s</div>`;
  } catch(e) {
...
function liveCardHtml(pick, fx) {
  ...
  if (!fx) {
    ...
    return `<div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.09);border-radius:12px;padding:.6rem .8rem;margin-bottom:.5rem;">
      ...
      <div style="font-family:\'IBM Plex Mono\',monospace;font-size:.58rem;color:rgba(255,255,255,.85);margin-top:.2rem;">${pick.pickLabel||pick.pick} @ ${pick.odds}${dt ? ' · 📅 ' + dt : ''} · ⏳ Nog niet begonnen</div>
    </div>`;
  }
  ...
  return `<div style="background:rgba(255,255,255,0.05);border:1.5px solid ${borderColor};border-radius:12px;padding:.6rem .8rem;margin-bottom:.5rem;">
    ...
    <div style="text-align:center;font-family:\'IBM Plex Mono\',monospace;font-size:.54rem;color:rgba(255,255,255,.85);margin-top:.35rem;padding-top:.35rem;border-top:1px solid rgba(255,255,255,0.09);">
