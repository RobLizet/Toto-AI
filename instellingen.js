  ...
  el.innerHTML = `
    <div class="app">
      <div class="topbar" style="display:none">
        ...
        <div id="authUserInfo" style="margin-left:auto;font-family:monospace;font-size:.52rem;color:rgba(255,255,255,.95);text-align:right;max-width:200px;"></div>
      </div>
    ...
    "picks": { ".read": "auth != null", ".write": "auth != null" },
      ...
      <div class="settings-section">
        ...
        <div style="font-family:monospace;font-size:.52rem;color:rgba(255,255,255,.95);line-height:1.8;">
          ...
          <div style="margin-top:.4rem;font-size:.47rem;color:rgba(255,255,255,.95);">
