    ...
    <div class="app">
      ...
      <div class="settings-section">
        ...
        <div style="margin-top:.4rem;">
          <button class="small-action-btn" onclick="startAutoCheckScheduler();showToast('▶ Scheduler gestart')">▶ Start nu</button>
        </div>
      </div>
      ...
      <div class="settings-section">
        ...
        <div style="font-family:monospace;font-size:.52rem;color:var(--sub);line-height:1.8;">
          <div>TOTO AI v12.0 · AppsMadeByRobB</div>
          <div>🌐 toto-ai.app</div>
...
const ANTHROPIC_PRICES = {
  ...
  'default':                   { input: 0.00000025, output: 0.00000125 }
};
...
function updateCostUI() {
  ...
  set('costTokensIn',  costs.tokensIn.toLocaleString());
  set('costTokensOut', costs.tokensOut.toLocaleString());
  set('costTotal',     '$'+costs.totalUSD.toFixed(4));
  set('costCalls',     costs.calls);
}
