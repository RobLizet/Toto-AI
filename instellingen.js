  ...
  el.innerHTML = `
    <div class="app">
      <div class="topbar" style="display:none">
        ...
        <div id="authUserInfo" style="margin-left:auto;font-family:monospace;font-size:.52rem;color:rgba(255,255,255,.85);text-align:right;max-width:200px;"></div>
      </div>
      ...
      <div class="settings-section">
        ...
        <div class="settings-field">
          ...
          <div style="font-family:monospace;font-size:.47rem;color:rgba(255,255,255,.85);margin-top:2px;">Voor AI-analyse · console.anthropic.com</div>
        </div>
        ...
        <div class="settings-field">
          ...
          <div style="font-family:monospace;font-size:.47rem;color:rgba(255,255,255,.85);margin-top:2px;">Jouw eigen Football API key (rapidapi.com)</div>
        </div>
        ...
        <div class="settings-field">
          ...
          <div style="font-family:monospace;font-size:.47rem;color:rgba(255,255,255,.85);margin-top:2px;">football-data.org voor gratis quotes</div>
        </div>
      </div>
      ...
      <div class="settings-section">
        ...
        <div class="settings-field">
          ...
          <div style="font-family:monospace;font-size:.47rem;color:rgba(255,255,255,.85);margin-top:2px;">Huidig saldo: <span id="currentBalanceDisplay">—</span></div>
        </div>
      ...
      <div class="settings-section">
        ...
        <div style="font-family:monospace;font-size:.52rem;color:rgba(255,255,255,.85);margin-bottom:.75rem;line-height:1.5;">
      ...
      <div class="settings-section">
        ...
        <div class="settings-row">
          <div>
            ...
            <div style="font-family:monospace;font-size:.47rem;color:rgba(255,255,255,.85);">Verbergt B/C-picks in het overzicht — focus op de sterkste signalen</div>
          </div>
      ...
      <div class="settings-section">
        ...
        <div class="settings-row">
          <div>
            ...
            <div style="font-family:monospace;font-size:.47rem;color:rgba(255,255,255,.85);">Value alerts en wedstrijd herinneringen</div>
          </div>
        ...
        <div id="notifEnabledSection">
          <div class="settings-field" style="margin-top:.5rem;">
            ...
            <div style="font-family:monospace;font-size:.47rem;color:rgba(255,255,255,.85);margin-top:2px;">Minimale value % voor push alert</div>
          </div>
      ...
      <div class="settings-section">
        ...
        <div class="settings-row">
          <div style="font-family:monospace;font-size:.5rem;color:rgba(255,255,255,.85);line-height:1.6;">
      ...
      <div class="settings-section">
        ...
        <div class="settings-row">
          <div>
            ...
            <div style="font-family:monospace;font-size:.47rem;color:rgba(255,255,255,.85);">Schakel automatisch naar dark bij nacht</div>
          </div>
      ...
      <div class="settings-section">
        ...
        <div style="font-family:monospace;font-size:.5rem;color:rgba(255,255,255,.85);margin-bottom:.6rem;">Pick statistieken, ROI curve en scan log analyse.</div>
      ...
      <div class="settings-section">
        ...
        <div id="fbBackupInfo" style="font-family:monospace;font-size:.52rem;color:rgba(255,255,255,.85);margin-bottom:.75rem;line-height:1.5;">Laden...</div>
        <div style="display:flex;gap:.4rem;flex-wrap:wrap;">
      ...
      <div class="settings-section">
        ...
        <div id="authAccountSection">
          <div style="font-family:monospace;font-size:.55rem;color:rgba(255,255,255,.85);margin-bottom:.6rem;line-height:1.6;">
      ...
      <div class="settings-section">
        ...
        <div style="font-family:monospace;font-size:.48rem;background:rgba(15,23,42,.05);border-radius:10px;padding:.6rem .8rem;color:rgba(255,255,255,.85);margin-bottom:.5rem;white-space:pre-wrap;">{
  "rules": {
    "users": {
      "$uid": {
        ".read": "$uid === auth.uid",
    ...
    "picks": { ".read": "auth != null", ".write": "auth != null" },
      ...
      <div class="settings-section">
        ...
        <div style="font-family:monospace;font-size:.52rem;color:rgba(255,255,255,.85);line-height:1.8;">
          <div>ProMatchXI <span id='appVersionLabel'></span> · AppsMadeByRobB</div>
          <div>🌐 promatchxi.app</div>
          <div>📧 zweetzakken@gmail.com</div>
          <div style="margin-top:.4rem;font-size:.47rem;color:rgba(255,255,255,.85);">
