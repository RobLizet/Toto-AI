  ...
  if (false) { // uitgeschakeld — altijd volledige config
    ...
    if (!postWK) {
      ...
      leagueConfig = [
        ...
        // v303: Scandinavische zomercompetities TERUG. Ze stonden in FASE 1 en verdwenen op 20-07
        // met de overgang naar CLUB19, terwijl hun seizoen apr-nov loopt -- ze spelen dus gewoon
        // door. Dat het per ongeluk ging blijkt uit NEXT_LEAGUES hieronder: die noemt 103 en 113
        // nog steeds als 'actieve zomer-leagues', dus twee plekken in dezelfde functie waren het
        // oneens. Bijeffect daarvan: SCAN_LEAGUES en NEXT_LEAGUES hadden geen overlap meer, dus
        // de next=-herstelroute (die er juist voor deze UTC-leagues is) kon niet meer vuren.
        // GEMETEN 24-07 bij api-sports over 14 dagen: CLUB19 heeft 94 fixtures maar extreem
        // geklonterd -- 51 op 30-07 en vier dagen met nul of een. Eliteserien+Allsvenskan leveren
        // 29 fixtures die precies in die gaten vallen (9 op 26-07, 7 op 02-08, 2 op 27-07).
        // Dat telt voor de validatieteller: de go/no-go vraagt >=100 clubpicks, en tot de
        // binnenlandse competities op 07-08 beginnen is dit vrijwel het enige weekendvolume.
        { id: 103, s: 2026 }, // Eliteserien (Noorwegen) — seizoen apr-nov, speelt nu
        { id: 113, s: 2026 }, // Allsvenskan (Zweden) — seizoen apr-nov, speelt nu
      ];
      console.log('[Scan] FASE 2 — Post-WK Europese seizoen: 21 leagues actief');
    }
  }
