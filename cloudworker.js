...
async function verifyYesterdayPicks(env) {
  ...
  for (const [id, pick] of picksWithResult) {
    ...
    updated++;
    updatedIds.push(id);
    if (won) gewonnenPicks.push(pick); // v326
  }
