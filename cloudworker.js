// TOTO AI Cloudflare Worker v10
// Nieuw in v10:
//   • /anthropic  → Anthropic Claude API (key veilig via env.ANTHROPIC_KEY)
//   • /apif/*     → API-Football v3 (key veilig via env.FOOTBALL_KEY)
//   • /fd/*       → football-data.org (key veilig via env.FD_KEY)
//   • /health     → status check
//   • Oude ?url=proxy blijft beschikbaar als fallback
//   • Alle bestaande push/FCM/VAPID/OneSignal/TWA functionaliteit ongewijzigd

const SA = {
  project_id: 'toto-ai-397cb',
  client_email: 'firebase-adminsdk-fbsvc@toto-ai-397cb.iam.gserviceaccount.com',
  private_key: '-----BEGIN PRIVATE KEY-----\\ndDnZKztWBigUNrWT/uWtdx7+\n-----END PRIVATE KEY-----\n'
};

const ONESIGNAL_APP_ID  = 'a6786d07-361d-44e5-b1d9-34ce7af00eed';
const ONESIGNAL_API_KEY = 'os_v2_app_uz4g2bzwdvcolmozgthhv4ao5x6amzlu2ututuuatdgcplm7fqdcnsqwycdelkakseqpr5uqmmrzhqtgdfbz2psd6abblvrcci3je5q';
const VAPID_PRIVATE_KEY = 'gU7CmPyj8mMYZdHTjh8bqP4opvkS2kZzwBvb8QhpTgY';
    ...
    if (path === '/push/send' && request.method === 'POST') {
      try {
        ...
        if (type === 'onesignal' && playerId) {
          const osKey  = env.ONESIGNAL_API_KEY || ONESIGNAL_API_KEY;
