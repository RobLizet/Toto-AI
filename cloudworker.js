...
export default {
  ...
  async scheduled(event, env, ctx) {
    ...
    ctx.waitUntil((async () => {
      ...
      // v287: bezorgcijfers van recente pushes bijwerken. Buiten beide takken (ook in de
      // rustige uren) en ontkoppeld: telemetrie mag nooit een scan blokkeren.
