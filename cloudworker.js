      ...
      try {
        ...
        try {
          ...
          for (const j of VERWACHTE_JOBS) {
            ...
            if (min > j.maxMin) warnings.push(`job_verouderd(${j.naam}, ${min}m van max ${j.maxMin}m)`);
