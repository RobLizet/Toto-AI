...
// handmatige en automatische analyse dezelfde stand-interpretatie gebruiken.
function extractStandingInfoWorker(standings, teamId) {
...
${analyseBatch.map((m, i) => {
  ...
  if (st) {
    ...
    if (standTable) {
      const hStand = extractStandingInfoWorker(standTable, m.homeId);
      const aStand = extractStandingInfoWorker(standTable, m.awayId);
