...
async function loadTuneConfig(env) {
  try {
    ...
    console.log(`[Tune] config geladen: s1=${TUNE.s1} s2=${TUNE.s2} elo_blend_w=${ELO_BLEND_W} lambda_anchor_w=${LAMBDA_ANCHOR_W} calib_factor_w=${CALIB_FACTOR_W}`);
