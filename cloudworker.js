...
async function handleAPIFootball(path, env, bypassCache = false) {
  ...
  if (cacheable) {
    try { const hit = await _cache.match(_cacheKey); if (hit) return hit; } catch(e) {}
  }
