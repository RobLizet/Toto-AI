...
async function syncCompetities(env) {
  try {
    const rows = FASE2_LEAGUES.map(l => ({
      ...
      in_validation: true, updated_at: new Date().toISOString(),
    }));
