  ...
  async fetch(request, env) {
    ...
    if (path === '/vvv-news') {
      try {
        ...
        return json({ items: [], error: 'fetch: ' + e.message });
      }
    }
