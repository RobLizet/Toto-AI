...
export default {
  ...
  if (path === '/scan-test') {
    ...
    return json({
      version: VERSION,
      status: 'running',
      routes: ['/apif/*', '/fd/*', '/anthropic', '/picks', '/user-costs', '/scan', '/scan-test', '/settle', '/debug-scan', '/check-odds', '/keepalive', '/push', '/push-status', '/am-i-admin', '/daily-tip', '/analytics', '?url=']
    });
  },
