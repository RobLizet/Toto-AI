...
async function runScan(env, force = false, skipTellerReset = false) {
  ...
  const oddsMap = await fetchOddsForFixtures(fixtureIds, env, 130, ENABLE_GOAL_MARKETS, allMatches, null, rawBooksMap, goalStatusMap);
