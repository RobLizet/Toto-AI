    ...
    if (path === '/alt-model-test') {
      ...
      try {
        const r = await fetch('https://api.anthropic.com/v1/messages', {
          ...
          body: JSON.stringify({ model: naam, max_tokens: 64, temperature: 0,
