...
${analyseBatch.map((m, i) => {
  ...
  return `${i+1}. ${m.home} vs ${m.away} (${m.leagueName}, ${m.matchDate || 'datum?'})${tournTag}${oddsStr}${injStr}`;
}).join('\n')}
