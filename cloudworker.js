...
async function fetchOddsForFixtures(fixtureIds, env, maxCalls = 36, enableGoals = false, matches = null) {
  ...
  try {
    ...
    if (_perLeague) {
      ...
      if (comboFouten) oddsMap._onvolledig = comboFouten; // vlag voor de aanroeper; telt niet als fixture
    } else {
