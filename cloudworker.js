...
async function verifyYesterdayPicks(env) {
  ...
  for (let i = 0; i < picksWithResult.length; i++) {
    ...
    try { await saveCLV(pick, clv, won, closingOdd || null, env, result.kickoff); } catch(e) { console.error('[SB] CLV fout:', e.message); }
