...
const LEAGUE_FACTORS = {
  ...
  43: 0.90,  // Keuken Kampioen Divisie (NL)
...
function activeLeagueIds(today) {
  ...
  return postWK
    ? [39, 140, 78, 135, 61, 88, 94, 144, 179, 207, 203, 2, 3, 848, 43, 79, 80, 40, 41]
    : [1, 103, 113];
}
