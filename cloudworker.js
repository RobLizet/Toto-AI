...
Exact ${analyseBatch.length} objecten, zelfde volgorde.`;
  ...
  try {
    ...
    if (anchorRows.length) {
      ...
      console.log(`[LambdaAnchorShadow] ${anchorRows.length} duel(s) gelogd (raw vs anchor w=0,50 vs markt)`);
    }
