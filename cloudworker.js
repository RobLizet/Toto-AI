  ...
  async fetch(request, env) {
    ...
    if (path === '/leagues') {
      return new Response(JSON.stringify({
        ...
        gescand: FASE2_LEAGUES.map(l => ({ id: l.id, seizoen: l.s, categorie: l.cat, naam: l.naam })),
      }), {
        headers: {
          'Content-Type': 'application/json',
