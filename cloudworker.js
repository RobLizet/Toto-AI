  ...
  async fetch(request, env) {
    ...
    if (path === '/health') {
      try {
        ...
        let clvMarkt = null;
        try {
          const cm = await sb(env, 'v_clv_per_market', 'GET', null, '?select=markt,picks,hitrate,avg_clv,roi_pct&order=picks.desc');
