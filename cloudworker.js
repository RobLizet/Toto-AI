...
async function verifyYesterdayPicks(env) {
  ...
  if (teVoiden.length) {
    for (const [id, pick] of teVoiden) {
      ...
      try {
        await sb(env, 'picks', 'PATCH', { status: 'void', settled_at: new Date().toISOString() },
