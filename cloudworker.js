  ...
  async fetch(request, env) {
    ...
    if (path === '/health') {
      try {
        ...
        // v352: LAMBDA-ANKER-SCHADUWKAART, zelfde patroon als xG hierboven. Leest
