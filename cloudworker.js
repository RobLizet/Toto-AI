...
async function runScan(env, force = false) {
  ...
  const oddsMap = await fetchOddsForFixtures(fixtureIds, env, 80, ENABLE_GOAL_MARKETS, allMatches, null, rawBooksMap, goalStatusMap);
