...
async function fetchOddsForFixtures(fixtureIds, env, maxCalls = 36, enableGoals = false, matches = null) {
  ...
  try {
    ...
    if (enableGoals) {
      ...
      console.log(`[Odds] Goal-markten: ${withGoals}/${Object.keys(oddsMap).length} fixtures met O/U of BTTS (${toFetch.length} calls, ${failed} gefaald, ${empty} leeg)`);
    }
  } catch (e) {
