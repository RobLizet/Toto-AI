...
const APP_VERSION = 'v26.177'; // v26.177: i18n — Wedstrijdkaart-uitslagen (THUIS/GELIJK/UIT, meer-minder-goals) + value-picks lege staat NL/EN // v26.176: i18n — Wedstrijden eerste pass (handmatige invoer, knoppen, laad/lege-meldingen) NL/EN // v26.175: i18n — Dashboard-body (nav-tegels, deze week, trackrecord-status, disclaimer, live-sectie, comp-kiezer) NL/EN // v26.174: i18n — Instellingen onderkant compleet (backups/kosten/account/db/admin/knoppen + korte hints) NL/EN // v26.173: i18n — Instellingen-velden/hints/toggles (bovenste secties) + Dashboard eerste pass (koppen/knoppen) NL/EN // v26.172: i18n fase 2 vervolg — Instellingen-sectietitels + Opslaan + 3 modals (Bet/Tracker/Storten) vertaald (NL/EN) // v26.171: i18n fase 2 (app-chrome) — data-i18n motor + nav/login-tabs vertaald (NL ongewijzigd, EN toegevoegd) + cookievoorkeuren-knop in Instellingen // v26.170: i18n fundament (fase 1) — i18n.js met t()-helper, lang in settings, taalknop in Instellingen (NL/EN, NL=default+fallback) // v26.169: cookie-consent banner + Google Consent Mode v2 (analytics_storage standaard denied; banner accepteren/weigeren, NL/EN, heropenbaar via pmxOpenConsent) // v26.168: JSON-LD structured data (SoftwareApplication) toegevoegd aan index.html + welcome.html voor SEO — naam, categorie, zoekwoorden (value betting voetbal, AI voetbalanalyse, voetbal value picks e.a.), NL/EN, 18+
