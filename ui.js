...
const HELP_TEXTS = {
  ...
  'clv':                { title: '\ud83d\udcc8 CLV \u2014 Closing Line Value', text: 'CLV meet of je een betere prijs pakte dan de slotkoers vlak voor de aftrap. Positieve CLV = je odds waren hoger dan waar de markt uiteindelijk op sloot. Dat is een sterk teken dat je systematisch value pakt \u2014 los van of \u00e9\u00e9n weddenschap wint of verliest. Profs sturen hier vaak op.' },
  'auto-kalibratie':    { title: '\ud83c\udf9b\ufe0f Auto-kalibratie', text: 'Het systeem stelt de modelinstellingen automatisch iets bij op basis van hoe goed eerdere tips uitkwamen. Kleine, begrensde stapjes, alleen bij voldoende data, wekelijks en volledig gelogd. Zo blijft het model scherp zonder handmatig werk. Werkt pas echt met clubdata na 20 juli.' },
  'league-rating':      { title: '\ud83c\udfc6 Competitie-rating', text: 'Geeft aan hoe betrouwbaar de voorspellingen per competitie zijn, op basis van de historische hitrate. Een hogere factor betekent dat het model het in die competitie beter doet; dat weegt mee in de kansberekening.' },
  'pick-tier':          { title: '\u2b50 Pick tiers', text: 'Picks worden gerangschikt op kwaliteit (Elite / A+ / A / B / C) \u2014 een combinatie van value, confidence en betrouwbaarheid. Hogere tiers zijn de sterkste signalen. Deze sectie toont hoe elke tier historisch presteerde.' },
  'result-type':        { title: '\ud83c\udfb2 Uitslag-type', text: 'Toont hoe de picks per markttype presteren (1X2, meer/minder goals, beide teams scoren), zodat je ziet in welke markten het model het sterkst is.' },
  'tip':                { title: '\ud83c\udfaf TIP-hoekje', text: 'Het hoekje toont de tip van de app. Fel gekleurd = de AI vond value (voordeel t.o.v. de markt). Licht = de AI analyseerde de wedstrijd en leunt hierheen, maar zonder value. "MARKT" = de AI heeft deze wedstrijd nog niet gescand; je ziet dan tijdelijk de markt-favoriet, tot de scan \'m bereikt.' },
  'kans':               { title: '\ud83c\udfaf Modelkans', text: 'De modelkans is hoe waarschijnlijk de app deze uitkomst acht, op basis van Poisson-statistiek en AI-analyse. Vergelijk dit met de kalibratie-regel eronder: die laat zien hoe vaak zulke kansen historisch echt uitkwamen.' },
  'calibratie':         { title: '\ud83e\udd16 AI-nauwkeurigheid', text: 'Dit vergelijkt wat het model vooraf voorspelde met wat er echt gebeurde. De banden groeperen tips op modelkans (bijv. 65%+). Gaf het model 65%+ en kwamen die 68% uit, dan is het goed gekalibreerd. "Gem. afwijking" vat samen hoe ver voorspelling en realiteit gemiddeld uiteenliggen \u2014 lager is beter.' },
